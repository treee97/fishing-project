...
const Navbar = () => {
	...
	}, [session, prevScrollPos]);
	//
	return (
		// fixed top-0 left-0 z-50
		<nav
			className={`fixed bg-black bg-opacity-20 left-0 z-50 w-full h-20 flex items-center justify-around transition-all duration-300 ease-in-out ${
